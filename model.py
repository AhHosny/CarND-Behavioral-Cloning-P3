...
def get_model():
    ...
    model.add(Conv2D(32, (5, 5), input_shape=(64, 64, 3), strides=(2, 2), padding="same"))
    model.add(ELU())
...
if __name__ == "__main__":
    ...
    steps_per_epoch = (20000//BATCH_SIZE)*BATCH_SIZE

    model.fit_generator(training_generator, validation_data=validation_data_generator,
                        steps_per_epoch=steps_per_epoch, epochs=3, validation_steps=3000)
